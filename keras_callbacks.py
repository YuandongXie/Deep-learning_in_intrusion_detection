from tensorflow_core.python.keras.callbacks import Callback, EarlyStopping
import utility
import logging
import numpy as np
...
# A tensorflow_core.python.keras callback to save an ML model (of our custom type) at intervals of epochs during training
